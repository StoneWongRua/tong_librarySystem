...
public class ReturnBook extends JFrame {
	...
	public ReturnBook() {
		...
		JLabel lblBookBorrow = new JLabel("归还书籍 ");
		...
		JButton btnIssueBook = new JButton("归还书籍");
		btnIssueBook.addActionListener(new ActionListener() {//添加事件
			...
			if(BookDao.checkBook(ISBN)){
				...
				int i = BookDao.back(ISBN, bookName, readerNo, readerTel, date);
				
				if(i > 0){
						JOptionPane.showMessageDialog(ReturnBook.this,"成功归还该书！");
						System.exit(0);
				}
				else {
				...
				JOptionPane.showMessageDialog(ReturnBook.this,"抱歉，该书不存在!");
				System.exit(0);
			}
